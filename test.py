...
def parse_args():
    ...
    parser.add_argument('--trees', '-t', dest='trees', default=10, type=int, help='number of trees in forest')
    parser.add_argument('--with-replacement', '-r', dest='replacement', default=True, action='store_true',
                        help='use same record many times when creating sample data for decision tree?')
